...
import static barikoi.dscc.dsccholdingtax.Api.resetpassUrl;

/**
 * Custom Alert Dialogues are created through this class
...
public class ViewDialog {
    ...
    /**
     * This is shown after auth failure of an user
     * @param activity
     */
     ...
     * Custom Message
     * @param activity
     * @param title for the dialog tile
     * @param message shows the dialog message
     */
    ...
    public void showFinishDialog(final Activity activity, String message){
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.length()>0 ){
                    ...
                    pd.setMessage(activity.getString(R.string.processing_request));
                    pd.show();
    ...
    /**
     * Used in the changed Password Activity
     *  @param container
     * @param title
     * @param message
     */
